...
```
##         time variable value
## 1 1987-01-01     year  1987
## 2 1987-02-01     year  1987
## 3 1987-03-01     year  1987
## 4 1987-04-01     year  1987
```
...
```
##         time variable   value
## 1 1980-01-01   us_gdp 1631.22
## 2 1980-04-01   us_gdp 1598.15
## 3 1980-07-01   us_gdp 1595.72
## 4 1980-10-01   us_gdp 1625.30
```
...
```
##         time variable    value
## 1 1980-01-01   us_gdp 45.83930
## 2 1980-04-01   us_gdp 44.90999
## 3 1980-07-01   us_gdp 44.84170
## 4 1980-10-01   us_gdp 45.67294
```
...
```
##     variable_names                                         variable_text
## 1    totus_supd_sa US, supply, average daily in millions, seas. adjusted
## 2    totus_supd_sf               US, supply, average daily, seas. factor
## 3   totus_supd_fct                                                  <NA>
## 4 totus_supd_irreg                                                  <NA>
## 5  totus_revpar_sa                            US, RevPAR, seas. adjusted
## 6  totus_revpar_sf                                                  <NA>
```

Displays palette and sets the ts1 theme
![plot of chunk set_theme](figure/set_theme-1.png) 

```
## Error in as.vector(y): could not find function "theme_ts1"
```

## Slide with Plot
Monthly demand and quarterly GDP
![plot of chunk monthly_demand_gdp](figure/monthly_demand_gdp-1.png) ![plot of chunk monthly_demand_gdp](figure/monthly_demand_gdp-2.png) 
...
## Slide with Plot
![plot of chunk room_demand_plot](figure/room_demand_plot-1.png) 

## Slide with Plot
![plot of chunk room_demand_plot3](figure/room_demand_plot3-1.png) 

## Slide with Plot
Example of filtering to select two variables
![plot of chunk room_demand_plot4](figure/room_demand_plot4-1.png) ![plot of chunk room_demand_plot4](figure/room_demand_plot4-2.png) 

## Slide with Plot
Example of selecting two variables using separate dataframe approach
![plot of chunk room_demand_plot5](figure/room_demand_plot5-1.png) ![plot of chunk room_demand_plot5](figure/room_demand_plot5-2.png) 

## Slide with Plot
Example of filtering to select one variables
![plot of chunk room_demand_plot6](figure/room_demand_plot6-1.png) 


![plot of chunk autoplot_example](figure/autoplot_example-1.png) 
...
![plot of chunk finalexample](figure/finalexample-1.png) 
