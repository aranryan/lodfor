...
variable_text <- c(paste("Index (",index_year,"=100)",sep=""))
variable_legend_1 <- c("Room demand")
variable_legend_3 <- c("Room demand forecast")
variable_legend_2 <- c("GDP")
...
p1 <- ggplot() +
  geom_line(data = temp[temp$date<=as.Date("2014-10-01"),], aes(x = date, y = value, color=variable), size = .9) + 
  geom_line(data = temp[temp$date>=as.Date("2014-10-01"),], aes(x = date, y = value), color="grey60", size=.9) + 
  geom_line(data = temp2, aes(x = date, y = value, color=variable), size = .9) +
  ggtitle(variable_text) +
  theme(legend.position=c(1, .2)) +
  scale_x_date(breaks = "1 year", labels = date_format("%Y")) +
  scale_color_manual(values = c(mypallete[9:9], "grey40"), labels=c(variable_legend_1,variable_legend_2)) 
plot_title_1(plot=p1, grtitle=grtitle, footnote=footnote)
a <- recordPlot()
replayPlot(a)
...
p1 <- ggplot(temp, aes(x = date, y=value)) +
  ...
  geom_line(data = temp[temp$date>=as.Date("2014-10-01"),], color="grey60", size=.8) +
...
p1 <- ggplot() + 
  ...
  geom_line(data = temp[temp$date>=as.Date("2014-10-01"),], 
            aes(x = date, y = value), color="grey60", size=.8) +
 ggtitle(variable_text) + 
 scale_color_manual(values = c(mypallete[10:10], "grey70")) +
