...
fname <- paste0(fpath, "/input_data/LODFOR_OEF_USMACRO_2016_08_01.csv")
...
```
## 'data.frame':	264 obs. of  46 variables:
##  $ date      : Date, format: "1980-01-01" "1980-04-01" ...
...
##  $ mx_pc     : num  0.0872 0.0937 0.1039 0.1061 0.1116 ...
...
##  $ wd_gdp    : num  6926660 6823820 6793100 6786620 6842550 ...
##  $ wd_gdpppp : num  7350380 7315230 7348720 7401680 7469510 ...
##  $ wd_gdpnusd: num  2754340 2767740 2781370 2795220 2818160 ...
```
