...
knitr::opts_chunk$set(echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, cache.path='../output_data/cache/', autodep=TRUE, fig.width=9, fig.height=5.7, dpi=600)
...
p1 <- ggplot(temp, aes(x = date, y=value)) +
  ...
  geom_line(data = temp[temp$date<=as.Date("2016-10-01"),], color=mypallete[9:9], size=.6, linetype = 1)
p1
...
p2
 ...
 plot_title_4(plot=p2, grtitle=grtitle, footnote=footnote, subtitle=subtitle,
              filename =  "~/Project/R projects/lodfor/output_data/figure_us_overview_graphs/fig-test_ggsave_0_R600dpi-occupancy_forecast.png")
