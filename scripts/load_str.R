...
lodus_m <- read.zoo("~/Project/R projects/lodging graphs/input_data/lodgeus_str_m.csv", 
...
lodus_q <- read.zoo("~/Project/R projects/lodging graphs/input_data/lodgeus_str_q.csv", 
  format = "%m/%d/%Y", header = TRUE, sep=",", colClasses=cl, index.column = 1) 
