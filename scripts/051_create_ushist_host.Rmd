...
autoplot(window(str_q$upachcil_adr_sar, start="2000-01-01", end="2014-10-01"))
autoplot(window(str_q$upachcil_revpar_sa, start="2000-01-01", end="2014-10-01"))
autoplot(window(str_q$upachcil_revpar, start="2000-01-01", end="2014-10-01"))
autoplot(window(str_q$luxusxxx_adr, start="2000-01-01", end="2014-10-01"))

# merges onto ushist_q
ushist_q <- merge(temp_usmac, str_q)

autoplot(window(ushist_q$upausxxx_adr, start="2000-01-01", end="2014-10-01"))
autoplot(window(ushist_q$upausxxx_adr_sa, start="2000-01-01", end="2014-10-01"))
autoplot(window(ushist_q$upausxxx_adr_sar, start="2000-01-01", end="2014-10-01"))
