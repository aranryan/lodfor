...
require("reshape2")
require("ggplot2")
#devtools::install_github("hadley/ggplot2") #added in 9-15 because I had ggsave issues
require("tidyr")
...
# function to estimate slope coefficient on quarterly data, using log format
...
#######
#
# function to put a tidy data frame with identfying columns such as a 
# geographic column and a date column into xts format
...
#########
#
# writing out function to run individual regressions for each metro
...
#########
#
# writing out function to run pooled and fixed effect regressions
#
...
# simple function to rbind dataframes when you want to keep all columns
# of both data frames
