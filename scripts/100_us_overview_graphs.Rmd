...
footnote <- c("Note: Seasonally adjusted. GDP quarterly. Room demand monthly through June 2015.\nSource: STR, Tourism Economics")
...
p1 <- ggplot() +
 ...
 geom_line(data = temp_a, aes(x = date, y = fitted, color = "grey70"), subset = .(hist == 1), size = .9) +
 geom_line(data = temp_a, aes(x = date, y = fitted, color = "grey70"), subset = .(hist == 0), size = .9, linetype="99") 
...
footnote <- c("Note: Seasonally adjusted.Historical data through June 2015. \nSource: STR; Bureau of Economic Analysis; Tourism Economics")
starta <- as.Date("2006-01-01")
enda <- as.Date("2015-10-01")
variable_text <- c("")
...
todo <- c("totus_revpar_sarpc")
grtitle <- c("Real RevPAR, US")
footnote <- c("Note: Seasonally adjusted. History through the second quarter of 2015. Forecast through the fourth quarter of 2017.\nSource: STR; Bureau of Economic Analysis; Tourism Economics")
starta <- as.Date("1987-01-01")
enda <- as.Date("2017-10-01")
variable_text <- c("")
