...
footnote <- c("Note: Seasonally adjusted. GDP quarterly. Room demand monthly through August 2015.\nSource: STR, Tourism Economics")
...
todo <- c("totus_demd_sa")
grtitle <- c("US room demand and GDP")
footnote <- c("Note: Seasonally adjusted, quarterly. Historical room demand through second quarter 2015. \nSource: STR, Tourism Economics")
starta <- as.Date("2004-01-01")
...
footnote <- c("Note: Data through second quarter 2015. Household survey employment. \nSource: STR; Bureau of Labor Statistics; Tourism Economics")
starta <- as.Date("1987-01-01")
enda <- as.Date("2015-10-01")
...
footnote <- c("Note: Seasonally adjusted. History through second quarter 2015, forecast through fourth quarter 2017.\nSource: STR; Tourism Economics")
...
todo <- c("totus_adr_sarpc")
grtitle <- c("Real ADR, US")
footnote <- c("Note: Seasonally adjusted.Historical data through second quarter of 2015. \nSource: STR; Bureau of Economic Analysis; Tourism Economics")
...
todo <- c("totus_adr_sa")
grtitle <- c("ADR, US")
footnote <- c("Note: Seasonally adjusted. History through second quarter of 2015. Forecast through fourth quarter of 2016.\nSource: STR; Tourism Economics")
starta <- as.Date("2004-01-01")
enda <- as.Date("2016-10-01")
variable_text <- c("")
...
todo <- c("totus_revpar_sarpc")
grtitle <- c("Real RevPAR, US")
footnote <- c("Note: Seasonally adjusted, 2014 dollars. History through the second quarter of 2015. Forecast through the fourth quarter of 2017.\nSource: STR; Bureau of Economic Analysis; Tourism Economics")
starta <- as.Date("1987-01-01")
enda <- as.Date("2017-10-01")
# most recent historical quarter
endq <- as.Date("2015-04-01")
variable_text <- c("")
...
footnote <- c("Note: Seasonally adjusted. Room demand quarterly through second quarter 2015.\nSource: STR, Tourism Economics")
...
footnote <- c("Note: Seasonally adjusted. Room supply quarterly through second quarter 2015.\nSource: STR, Tourism Economics")
variable_text <- c("Index (2006=100)")
index_year <- c(2006)
...
footnote <- c("Note: Seasonally adjusted data quarterly through second quarter 2015.\nSource: STR, Tourism Economics")
variable_text <- c("Index (2006=100)")
index_year <- c(2006)
todo <- c("supd_sa")
