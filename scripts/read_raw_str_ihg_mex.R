...
fname4 <- c("input_data/IHG Mexico upm consistent reporters - 672952_UPPERMIDSCALECO_PESOS.xls")
fname5 <- c("input_data/IHG Mexico upm consistent reporters - 672949_UPPERMIDSCALECO_USD.xls")
