...
oef_usmac_q <- window(oef_usmac_q, end = end)
```
...
autoplot(oef_usmac_q$us_gdp)

autoplot(oef_usmac_q$us_up)
...
write.zoo(oef_usmac_q, file="output_data/oef_usmac_q.csv", sep=",")
# saves Rdata versions of the output files
save(oef_usmac_q, file="output_data/oef_usmac_q.Rdata")
```
